...
assert {"allele_ids": ["VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F"], "completeness": "PARTIAL", "id": "VMC:GH_dmPKNQRhrnF-XRsqder9RTPz8ZjRtVLg"} == h1.as_dict()
assert {"allele_ids": ["VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F"], "completeness": "COMPLETE", "id": "VMC:GH_p1wCN7-eVQklcv6tg5d2DGVHCX3eCP2p"} == h2.as_dict()

g = models.Genotype(haplotype_ids=[h1.id, h2.id], completeness="COMPLETE")
g.id = computed_id(g)
genotypes = {g.id: g.as_dict()}
assert {"completeness": "COMPLETE", "haplotype_ids": ["VMC:GH_dmPKNQRhrnF-XRsqder9RTPz8ZjRtVLg", "VMC:GH_p1wCN7-eVQklcv6tg5d2DGVHCX3eCP2p"], "id": "VMC:GG_9uOweOFteefYsz-Vno_Yaw1itsjg8MI7"} == g.as_dict()
