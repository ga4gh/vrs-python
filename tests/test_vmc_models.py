...
assert "<Location:<Identifier:VMC:GS_01234>:<Interval:42:42>>" == serialize(l)
l.id = computed_id(l)
...
assert "<Allele:<Identifier:VMC:GL__e3BmXQJ0CYG0ZtXeZDBzBQkvnetKxgb>:A>" == serialize(a)
a.id = computed_id(a)
...
assert "<Haplotype::PARTIAL:[<Identifier:VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F>]>" == serialize(h1)
...
assert "<Haplotype::COMPLETE:[<Identifier:VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F>]>" == serialize(h2)
...
assert "<Genotype:COMPLETE:[<Identifier:VMC:GH__oZ5-57j6eI2M12RVJG46a3Q1LS-4IuN>;<Identifier:VMC:GH_zrCwcEZkWF4nDxSk5BQjrEwufUxCXEWq>]>" == serialize(g)
g.id = computed_id(g)
