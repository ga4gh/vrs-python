...
assert '{"id": "VMC:GL__e3BmXQJ0CYG0ZtXeZDBzBQkvnetKxgb", "interval": {"end": 42, "start": 42}, "sequence_id": "VMC:GS_01234"}' == str(l.serialize())


a = models.Allele(location_id=l.id, state="A")
a.id = computed_id(a)
alleles = {a.id: a.as_dict()}
assert '{"id": "VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F", "location_id": "VMC:GL__e3BmXQJ0CYG0ZtXeZDBzBQkvnetKxgb", "state": "A"}' == str(a.serialize())
...
assert '{"allele_ids": ["VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F"], "completeness": "PARTIAL", "id": "VMC:GH_dmPKNQRhrnF-XRsqder9RTPz8ZjRtVLg"}' == str(h1.serialize())
assert '{"allele_ids": ["VMC:GA_6DSejQb2b3Of9N5QXSULOTfU_7i9RA-F"], "completeness": "COMPLETE", "id": "VMC:GH_p1wCN7-eVQklcv6tg5d2DGVHCX3eCP2p"}' == str(h2.serialize())
